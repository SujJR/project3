...
class RestaurantManager(db.Model, UserMixin):
    ...
    username = db.Column(db.String(length=30), nullable=False, unique=True)
    fullname = db.Column(db.String(length=30), nullable=False)
    restaurant_name1 = db.Column(db.String(length=30), nullable=False)
    restaurant_name2 = db.Column(db.String(length=30), nullable=False)
    restaurant_name3 = db.Column(db.String(length=30), nullable=False)
    password_hash = db.Column(db.String(length=60), nullable=False)
